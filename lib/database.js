...
(function () {
    ...
    app.factory('database', [
        ...
        'database_name',
        'database_drop',
        function ($log, Database, constraints, migrations, database_name, database_drop) {
            if (database_drop) {
            ...
            var database = Database.loadDatabase(database_name) || Database.initDatabase(database_name);

            Database.migrateDatabase(database, constraints, migrations);
    ...
    app.factory('migrations', [
        ...
        function (Table, Migration) {
            return [
                Migration.create(function (database, constraints) {
