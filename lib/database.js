(function () {
    ...
    app.factory('database', [
        ...
        'database_name',
        'database_drop',
        function ($log, DatabaseFile, DatabaseTable, constraints, migrations, database_name, database_drop) {
            if (database_drop) {
...
//            DatabaseTable.insert(database, constraints, 'table1', {});

            var query = DatabaseFile.query(database, constraints, 'table1');
